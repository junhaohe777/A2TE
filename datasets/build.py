...
# class Choose:
#     def __init__(self, rand_from, size,mean,std):
...
#         T.RandomRotation(15),
#         T.RandomResizedCrop(img_size, (0.9, 1.0), antialias=True),
#         T.RandomGrayscale(),
#         T.RandomHorizontalFlip(),
#         T.RandomErasing(scale=(0.10, 0.20)),
#     ]
#     aug_1 = Choose(rand_from, img_size,mean,std)
...
#         #     T.ToTensor(),
#         #     T.Normalize(mean=mean, std=std),
#         #     T.RandomErasing(scale=(0.10, 0.20), value=mean),
#         # ])
#         transform = aug_1
#     else:
#         transform = T.Compose([
