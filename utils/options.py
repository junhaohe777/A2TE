...
def get_args():
    ...
    ######################## loss settings ########################
    parser.add_argument("--loss_names", default='sdm+id+mlm', help="which loss to use ['mlm', 'cmpm', 'id', 'itc', 'sdm', 'mim','js','attribute','nitc']")
    parser.add_argument("--mlm_loss_weight", type=float, default=1.0, help="mlm loss weight")
    parser.add_argument("--id_loss_weight", type=float, default=1.0, help="id loss weight")
    parser.add_argument("--attribute_weight", type=float, default=1.0, help="attribute loss weight")
    parser.add_argument("--pool_ratio", type=float, default=0.3, help="distill_lambda_feat")
    parser.add_argument("--detail_loss_weight", type=float, default=0.01, help="detail loss weight")
